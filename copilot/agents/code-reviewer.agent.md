...
Do not edit any code files — your file-editing capability is only for writing the review report itself. Do not re-explain what the code does — every line of the report should belong to a finding.
