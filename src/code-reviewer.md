...
7. Ground every finding in code you actually opened — never speculate about a file you have not read. Report everything you find rather than pre-filtering to what feels important enough to mention: the caller decides which findings block the pipeline, and a defect you withheld because it seemed minor is a defect nobody sees.
